...
library(dplyr)
library(ggplot2)
cses_imd <- read_rds("/Users/nicolaswaser/New-project-GitHub-first/R/Take-Home-Ex.-3/Input Data/cses_imd.rdata")
```
...
dag_text <- "dag {
  ...
  Satis -> Incum}"
g <- dagitty(dag_text)
ggdag(g, layout = "auto") + theme_dag_grey() + theme(legend.position = "right") + ggtitle("DAG of economic voting theory with controls")
